...
// in simulator we redefine to format for feed Developer console
...
{\
	NSString * exceptionName = [@"org.feed." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.feed";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIfeedNativeItemNone = -1, 
	UIfeedNativeItemSpinner = -2,
	UIfeedNativeItemProgressBar = -3,
	
	UIfeedNativeItemSlider = -4,
	UIfeedNativeItemSwitch = -5,
	UIfeedNativeItemMultiButton = -6,
	UIfeedNativeItemSegmented = -7,
	
	UIfeedNativeItemTextView = -8,
	UIfeedNativeItemTextField = -9,
	UIfeedNativeItemSearchBar = -10,
	
	UIfeedNativeItemPicker = -11,
	UIfeedNativeItemDatePicker = -12,
	
	UIfeedNativeItemInfoLight = -13,
	UIfeedNativeItemInfoDark = -14,
	
	UIfeedNativeItemDisclosure = -15,
	
	UIfeedNativeItemContactAdd = -16
};
